...
const DEPTH_COLORS = [
  'var(--aw-blue)', // depth 0 — blue (orchestrator)
  'var(--aw-purple)', // depth 1 — purple
  'var(--aw-green-bright)', // depth 2 — green
  'var(--aw-orange)', // depth 3 — orange
  'var(--aw-red-light)', // depth 4+ — salmon
];
